...
- update npm repo (#880)
- *(ci)* Workaround `discover_network_peers` test of `lumina-node-wasm` (#801)
...
- test release rc (#901)
- release (#879)
- *(node-wasm)* fix flaky head headers comparison (#878)
- release (#871)
- moves non re-usable types from types to rpc (#856)
- release (#861)
- *(node-wasm)* add proper tsconfig.json (#839)
- *(node-wasm)* fix flaky request_network_head_header (#837)
- fix tsc not finding iterators on release (#838)
- release (#815)
- *(node)* [**breaking**] Upgrade MSRV for `lumina-node` to 1.88 (#814)
- [**breaking**] Migrate to Rust 2024 (#773)
- bump version and update readme for npm release (#759)
- release (#757)
- release (#739)
- release (#725)
- release (#722)
...
- release (#461)
- release (#456)
- *(lumina-node-wasm)* release v0.5.2 (#445)
- release (#419)
- release (#413)
...
- *(ci)* Workaround `discover_network_peers` test of `lumina-node-wasm` ([#801](https://github.com/eigerco/lumina/pull/801))
