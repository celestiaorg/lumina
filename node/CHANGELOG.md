...
- *(node)* [**breaking**] Make HeaderEx aware of node types and connected peers (#807)
...
- *(node)* Node identity retention for native,ios,android (#751)
- *(node)* [**breaking**] Implement peer discovery based on node type (#761)
...
- *(node)* [**breaking**] Use `block_height` for `Node::request_all_blobs` and return error on missing header (#669)
...
- *(node)* [**breaking**] Make blockstore only store samples (#653)
- Fix doc builds, new rust? :thinking: (#650)
- *(node)* [**breaking**] Do not fail fast on dns-over-https (#648)
...
- *(node)* redial peers if we go below limits (#460)
...
- release (#871)
- release (#861)
- Fix typos, grammar in comments (#853)
- release (#815)
...
- release (#661)
- *(node)* Fix lifetime warning on nightly (#656)
- release (#652)
- update mocha validators to match celestia (#633)
- release (#630)
...
- release (#371)
- *(node)* Update rexie and related wasm dependencies (#358)
- release (#364)
...
- fix publishing lumina-node due to cyclic self-dev-dependency (#179)
- release (#177)
...
## [0.18.2](https://github.com/celestiaorg/lumina/compare/lumina-node-v0.18.1...lumina-node-v0.18.2) - 2026-01-27

### Fixed

- update npm repo ([#880](https://github.com/celestiaorg/lumina/pull/880))

## [0.18.1](https://github.com/eigerco/lumina/compare/lumina-node-v0.18.0...lumina-node-v0.18.1) - 2026-01-08

### Other

- updated the following local packages: celestia-types, celestia-types, celestia-types, celestia-rpc, celestia-rpc

## [0.18.0](https://github.com/eigerco/lumina/compare/lumina-node-v0.17.0...lumina-node-v0.18.0) - 2026-01-05
...
- Fix typos, grammar in comments ([#853](https://github.com/eigerco/lumina/pull/853))
...
- *(node)* [**breaking**] Upgrade MSRV for `lumina-node` to 1.88 ([#814](https://github.com/eigerco/lumina/pull/814))
