...
- *(types)* [**breaking**] Add appconsts for v5 upgrade (#705)
...
- add test struct
- release (#879)
- *(types)* [**breaking**] Support celestia-app V7 (#877)
- release (#871)
...
- *(types, node, grpc)* Network v4 upgrade, grpcwebproxy is back ([#674](https://github.com/eigerco/lumina/pull/674))
